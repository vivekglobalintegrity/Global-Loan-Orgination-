                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab"   href="<?php echo base_url('signup'); ?>"  >Register</a>
                            </li>
                        </ul>
                                  ...
                                  <div class="container h-100" style="text-align: center;">
                                    <div class="row justify-content-md-center h-100 register-form">
                                      <div class="card-wrapper">
                                        ...
                                        <div class="card fat">
                                          <div class="card-body">
                                            <h4 class="card-title">Customer Sign In</h4>
                                            <form method="post" action="<?php echo site_url("login"); ?>" class="my-login-validation" novalidate="" autocomplete="off">
...
<?php   }  ?>
                                                ...
                                                <input id="email" type="email" class="form-control" name="email" placeholder="Email" value="" required  autocomplete="off">
                                              ...
                                              <div class="form-group">
                                                <label for="password">Password
                                                  <a href="<?php  echo site_url('forget_password');  ?>" class="float-right">
                                                    Forgot Password?
                                                  </a>
                                                </label>
                                              ...
                                              <div class="form-group">
                                                <div class="custom-checkbox custom-control">
                                                  <input type="checkbox" name="remember" id="remember" class="custom-control-input new-cl" autocomplete="new-password" >
                                                  <label for="remember" class="custom-control-label">Remember Me</label>
                                                </div>
                                              </div>

                                              <div class="form-group m-0">
                                                <button type="submit" class="btnRegister" style="margin: 0;">
                                                  Login
                                                </button>
                                              </div>
