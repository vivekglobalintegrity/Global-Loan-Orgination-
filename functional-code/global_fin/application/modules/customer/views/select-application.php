      ...
      <div class="card ">
        ...
        <div class="card-body">
           <div class="col-sm-4 text-center Application">
               <img src="https://portal.limaone.com/assets/images/LineofCredit-ICON.png" class="mb-3" >
        ...
        <div class="card-body">
           <div class="row">
                <div class="col-sm-3 text-center Application">
                  <img src="https://portal.limaone.com/assets/images/FIXNFLIP-ICON@2x.png" class="mb-3" >
                ...
                <div class="col-sm-3 text-center Application">
                  <img src="https://portal.limaone.com/assets/images/RENTAL-ICON-166-271x125.png" class="mb-3" >
                  <p><a href="<?php echo site_url('admin/rental_app') ; ?>">
                    Purchase or refinance cash-flowing rental properties.
                  </a></p>
                </div>
                <div class="col-sm-3 text-center Application">
                  <img src="https://portal.limaone.com/assets/images/Multifamily-191x125.png" class="mb-3" >
                   <p><a href="#">
                     Application for Multifamily.
                  </a></p>
                </div>
                <div class="col-sm-3 text-center Application">
                  <img src="https://portal.limaone.com/assets/images/new-construction-for-website-home-page-2-271x125.png" class="mb-3" >
