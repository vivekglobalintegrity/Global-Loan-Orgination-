    ...
    <section class="content" style="padding-top: 10px;">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><strong>New Construction Application</strong></h3>
        </div>
        <div class="card-body">
          ...
          <ul class="real_estate_ck_bx">
              ...
              <li>
                  <div class="form-check">
                    <span class="radio_customize01">
                      <input class="form-check-input" type="radio" name="radio1">
                      <label class="form-check-label">Multifamily</label>
                    </span>                    
                  </div>
              </li> 
          </ul> 
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control">
                          ...
                          <option value="Vacant Lot- Ground Up Construction" >Vacant Lot - Ground Up Construction</option>
                          <option value="Tear Down &amp; Rebuild">Tear Down &amp; Rebuild</option>
                          <option value="Mid Construction Refinance">Mid Construction Refinance</option>
                    ...
                    <div class="col-md-6" >
                        ...
                        <div class="form-group">
                          <label>Lot Status <span>*</span></label>
                          <select class="form-control">
                            <option value="">Choose Option</option>
                            <option value="Purchasing Lot"  >Purchasing Lot</option>
                            <option  value="Paying Off Lot Loan" >Paying Off Lot Loan</option>
                            <option  value="Lot Owned Free &amp; Clear"  >Lot Owned Free &amp; Clear</option>
                          </select>
                        </div>
                    </div>
                    <div class="col-md-12"> <hr> </div>
                      ...
                      <hr>
                       <table class="table table-bordered">
                          <tbody>
                            <tr>
                               <td>
                                  <label>Do you have the required building permits yet? <span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
                            ...
                            <tr>
                               <td>
                                  <label>Is the lot already properly zoned and individually platted with a parcel ID#<span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
                               ...
                               <td>
                                  <label>Have you already completed any construction (including demo, lot prep, foundation work, etc.)<span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
                            ...
                            <tr>
                               <td>
                                  <label>Is the lot ready to build on within the next 60 days<span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
                               ...
                               <td>
                                  <label>Do you already have plans and specs? <span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
                            ...
                            <tr>
                               <td>
                                  <label>If you have sufficient equity in the lot you own, are you requesting cash out at closing? <span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
                               ...
                               <td>
                                  <label>Are utilities available at the lot? <span>*</span></label>
                                  <div class="form-group">
                                    <div class="form-check">
                                      <span class="radio_customize01">
                                        <input class="form-check-input" type="radio" name="radio1">
