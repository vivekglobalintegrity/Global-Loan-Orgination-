...
<head>
  ...
  <link rel="stylesheet" href="<?php   echo base_url() ; ?>admin-assets/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  ...
  <link rel="stylesheet" href="<?php   echo base_url() ; ?>admin-assets/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="<?php   echo base_url() ; ?>admin-assets/plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="<?php   echo base_url() ; ?>admin-assets/plugins/dropzone/min/dropzone.min.css">
  <!-- Theme style -->
      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          ...
          <li class="user-footer">
            <a href="<?php   echo site_url('customer/logout') ; ?>" class="btn btn-default btn-flat float-right">Sign out</a>
          </li>
        </ul>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!--  <li class="nav-item">
            <a href="select-application.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="calculator.html" class="nav-link" target="_blank">
...
<!-- Bootstrap4 Duallistbox -->
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
<!-- InputMask -->
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/moment/moment.min.js"></script>
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/inputmask/jquery.inputmask.min.js"></script>
<!-- date-range-picker -->
...
<!-- Bootstrap Switch -->
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- BS-Stepper -->
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/bs-stepper/js/bs-stepper.min.js"></script>
<!-- dropzonejs -->
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/dropzone/min/dropzone.min.js"></script>
<!-- jquery-validation -->
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="<?php   echo base_url() ; ?>admin-assets/plugins/jquery-validation/additional-methods.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php   echo base_url() ; ?>admin-assets/dist/js/adminlte.min.js"></script>
