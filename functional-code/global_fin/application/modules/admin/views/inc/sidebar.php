...
=="select_application"){ echo "active" ; }   ?>">
          ...
          <li class="nav-item  <?php  if($this->router->fetch_method()
=="full_app"){ echo "menu-open" ; }   ?> ">
            <a href="<?php  echo site_url('admin/full_app') ;  ?>" class="nav-link  <?php  if($this->router->fetch_method()
=="full_app"){ echo "active" ; }   ?> ">
          ...
          <li class="nav-item   <?php  if($this->router->fetch_method()
=="funded_loans"){ echo "menu-open" ; }   ?>">
            <a href="<?php  echo site_url('admin/funded_loans');  ?>" class="nav-link  <?php  if($this->router->fetch_method()
=="funded_loans"){ echo "active" ; }   ?>">
